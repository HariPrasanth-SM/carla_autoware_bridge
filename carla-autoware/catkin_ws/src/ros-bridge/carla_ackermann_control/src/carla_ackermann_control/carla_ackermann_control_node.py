...
class CarlaAckermannControl(object):
    ...
    def __init__(self):
        ...
        # self.control_subscriber = rospy.Subscriber(
        #     "op_controller_cmd",
        #     VehicleCmd, self.ackermann_command_updated)
    ...
    def ackermann_command_updated(self, ros_ackermann_drive):
        ...
        #self.set_target_steering_angle(ros_ackermann_drive.ctrl_cmd.steering_angle)
        # self.set_target_speed(-1*ros_ackermann_drive.ctrl_cmd.linear_velocity)
        # self.set_target_accel(ros_ackermann_drive.ctrl_cmd.linear_acceleration)
        # self.set_target_steering_angle(ros_ackermann_drive.ctrl_cmd.steering_angle)
